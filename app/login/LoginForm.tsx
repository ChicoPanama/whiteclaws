...
export default function LoginForm() {
  ...
  const handleWalletLogin = async () => {
    setError('');
    // Privy handles wallet connection when configured
    // Falls back to stub when PRIVY_APP_ID is not set
    try {
      const { usePrivy } = await import('@privy-io/react-auth');
      // This will be handled by PrivyProvider when configured
      setError('Wallet login requires Privy configuration. Set NEXT_PUBLIC_PRIVY_APP_ID.');
    } catch {
      setError('Wallet connection not yet configured.');
    }
  };
  ...
  return (
    <div className="lg-page">
      <div className="lg-wrap">
        ...
        <button onClick={handleWalletLogin} disabled={loading} className="lg-wallet-btn">
