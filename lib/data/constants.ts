...
export const platformFeatures: PlatformFeature[] = [
  {
    ...
    highlights: [
      ...
      'Scope Mode: Official (Tier 1) is live now',
    ],
  },
  {
    icon: '🧭',
    slug: 'surface-expansion',
    name: 'Surface Expansion (Opt-In)',
    comingSoon: true,
    description: 'Coming Soon · Premium · Protocol-Approved. Map full production footprint — factories, proxies, implementations, and upgrade paths — only with explicit protocol consent.',
    longDescription: 'Surface Expansion is an opt-in premium layer for protocols that explicitly authorize deeper footprint mapping beyond Tier 1 Official Scope. When enabled by protocol consent, WhiteClaws can map production blast radius through factories, proxy/implementation relationships, and upgrade paths. This feature is Coming Soon and is not active by default.',
    highlights: [
      'Factory expansion',
      'Proxy intelligence',
      'Dependency mapping',
      'Scoped by consent (safe harbor aligned)',
    ],
  },
  {
    icon: '🤖',
